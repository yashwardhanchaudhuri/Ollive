...
def generate(results, calibration, dataset, output_dir):
    ...
    lines.extend([
        ...
        f"The final comparison dataset contains **{len(cases)} custom single-turn cases** generated by scripts/build_eval_dataset.py and stored in evals/datasets/core.v1.jsonl. It contains no copied public benchmark prompts.",
        "",
