# Current best-effort matched report

## At a glance

| Field | Value |
|---|---|
| Raw run | `evaluation/runs/oss_frontier_best_effort_20260721.jsonl` |
| Combined manifest | `evaluation/runs/oss_frontier_best_effort_20260721.manifest.json` |
